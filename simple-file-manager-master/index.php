...
function rn($file){
    if(rename($file,"FileRenamed.txt"))
        echo '<script language="javascript">alert("File is renamed");</script>';
    else
        echo '<script language="javascript">alert("File cannot be renamed");</script>';
}
...
<?php endif; ?>
	...
	function renderFileRow(data) {
		...
		//Added Code
        var $rename_link = $('<a href="#" onclick="window.location.reload(true)"/>').attr('data-file',data.path).addClass('rename').text('rename');
		var perms = [];
